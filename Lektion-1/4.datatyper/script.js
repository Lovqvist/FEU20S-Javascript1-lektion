/* 
        ...
        undefined   =   Har eh blivit definierat an (automatiskt)
...
/* 
        Deklarera variabler
        -----------------------------------
        name        = 'Joakim' Gammalt sätt (ANVÄND INTE)
        var name    = 'Joakim' Gammalt sätt och kan krocka med andra element
        let name    = 'Joakim' Lokal variabler
        const name  = 'Joakim' 
        ...
        const = Lokal konstant variabel, kan inte skrivas lver men undantag finns  
...
/* 
        STRINGS:
            ...
            let name = 'Joakim* - Skriv så här ' '
            let name = `Joakim` - Template String - Används vid placeholders (Shift + `)
            

            avsluta varje rad med ; Inget som behövs men det är bra att göra då det symboliserar ett avslut        
